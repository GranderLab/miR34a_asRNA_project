...
pdf <- p +
  ...
  guides(
    colour = guide_legend(title = "Cell line", override.aes = list(size = 2))
  )

figure <- plotPDF(pdf)

path <- "~/GitHub/miR34a_asRNA_project/inst/figure3c_stableLineGrowthStarvation/figure3c_stableLineGrowthStarvation.pdf"
# ggsave(
#   plot = figure,
#   filename = path,
#   device = cairo_pdf,
