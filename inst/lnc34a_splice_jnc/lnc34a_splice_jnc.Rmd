...
nrCellLinesDown <- function() {
  ...
  url <- "suppFigure2e_lnc34aSplJnc.txt"
...
cellLinesInFinal <- function() {
  ...
  url <- "suppFigure2e_lnc34aSplJnc.rds"
...
path <- "~/GitHub/miR34a_asRNA_project/inst/suppFigure2e_lnc34aSplJnc/suppFigure2e_lnc34aSplJnc.pdf"
ggsave(
  plot = g, 
  filename = path, 
  device = cairo_pdf, 
