...
url <- fileMap(type = "rds")["figure3b"][[1]]
data <- read_rds(gzcon(url(file.path(dataUrl, url))))
...
figure <- plotPDF(pdf)
#path <- "~/GitHub/miR34a_asRNA_project/inst/figure3b_stableLineCellCycle/figure3b_stableLineCellCycle.pdf"
path <- file.path("~/GitHub/miR34a_asRNA_project/inst", fileMap(type = "pdf")["figure3b"][[1]])
