...
nrCellLinesDown <- function() {
  dataUrl <- "https://github.com/GranderLab/miR34a_asRNA_project/raw/master/data-raw"
  url <- "suppFigure2d_lnc34aCage.txt"
...
cellLinesInFinal <- function() {
  ...
  url <- "suppFigure2d_lnc34aCage.rds"
...
All available CAGE data from `r nrCellLinesDown()` cell lines was downloaded from UCSC with the script entitled "lnc34a CAGE" in the data-raw/saveRDA.R file. Of these `r cellLinesInFinal() %>% length()` cell lines had CAGE tags mapping to the plus strand of chromosome 1 and in regions corresponding to 200 bp upstream of the lnc34a start site (9241796 - 200) and 200 bp upstream of the GENCODE annotated miR34a asRNA start site (9242263 + 200). These cell lines included: `r cellLinesInFinal()`. All CAGE reads were plotted and the RPKM of the individual reads was used to color each read to indicate their relative abundance. In addition, a density plot shows the distribution of the CAGE reads at in the specified interval.
...
path <- "~/GitHub/miR34a_asRNA_project/inst/suppFigure2d_lnc34aCage/suppFigure2d_lnc34aCage.pdf"
ggsave(
  plot = g, 
  filename = path, 
  device = cairo_pdf, 
