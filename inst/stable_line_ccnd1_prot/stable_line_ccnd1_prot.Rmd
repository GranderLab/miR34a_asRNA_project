...
<div class="caption">
The resulting western blot showing the results from the three independant experiments.
</div>
...
url <- fileMap(type = "rds")["suppFigure3c"][[1]]
...
# path <- file.path("~/GitHub/miR34a_asRNA_project/inst", fileMap(type = "pdf")["suppFigure3c"][[1]])
# ggsave(
#   plot = figure,
#   filename = path,
#   device = cairo_pdf,
