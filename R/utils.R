...
fileMap <- function(type) {
  pList <- list(
    ...
    figure2c = "p1_construct/p1_construct.Rmd",
    figure2d = "p1_hct116_hek293t/p1_hct116_hek293t.Rmd",
    figure2e = "p1_shrna_renilla_dox/p1_shrna_renilla_dox.Rmd",
    ...
    suppFigure2a = "stable_line_expression_hek293t/stable_line_expression_hek293t.Rmd",
    suppFigure2b = "stable_line_ccnd1_exp/stable_line_ccnd1_exp.Rmd",
    suppFigure2c = "stable_line_ccnd1_prot/stable_line_ccnd1_prot.Rmd",
    suppFigure2d = "lnc34a_cage/lnc34a_cage.Rmd",
    suppFigure2e = "lnc34a_splice_jnc/lnc34a_splice_jnc.Rmd"
  )
